...
def load_dataset(augment_transform, input_transform, target_transform, size=16):
    ...
    train_loader = DataLoader(dataset=train_dataset, batch_size=size, shuffle=True)
    val_loader = DataLoader(dataset=val_dataset, batch_size=size, shuffle=False)
    test_loader = DataLoader(dataset=test_dataset, batch_size=size, shuffle=False)
